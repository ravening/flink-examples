...
public class StreamingGameScores {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final StreamingFileSink<String> sink = StreamingFileSink
                .<String>forRowFormat(new Path("flink-course/target/streamingSink"),
                        new SimpleStringEncoder<>("UTF-8")).build();
    ...
    public static class ExtractPlayersAndScoresFn
    ...
    public static class FilterPlayersAboveThresholdFn
    ...
    public static class ConvertToStringFn
